...
# ==============================================================================
# APPROACH 3: STAIRCASE SEARCH (ALTERNATIVE O(m + n))
# ==============================================================================
# Time Complexity: O(m + n) - not optimal for this problem but good to know
# Space Complexity: O(1)
#
# Bonus approach: Start from top-right corner and move like stairs

class Solution_Staircase:
    def searchMatrix(self, matrix, target):
        """
        Start from top-right corner and eliminate row or column each step.
        ...
        This works but is O(m+n), not O(log(m*n)) as required.
        """
        if not matrix or not matrix[0]:
            return False
